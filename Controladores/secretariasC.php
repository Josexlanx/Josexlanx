...
class SecretariasC{
	...
	public  function VerPerfilSecretariaC(){
		...
		echo '<tr>
				...
				echo '<td>
					...
					<a href="/proyectoclinica/perfil-S/'.$resultado["id"].'">
	...
	public static function EditarSecretariaC() {
        if(isset($_POST["Sid"])) {
            $tablaBD = "secretarias";
            $datosC = array(
                "id" => $_POST["Sid"],
            ...
            $resultado = SecretariasM::EditarSecretariaM($tablaBD, $datosC);
	...
	public function ActualizarPerfilSecretariaC(){
		...
		if(isset($_POST["idP"])){
			...
			if($resultado == true){
				...
				window.location = "/proyectoclinica/perfil-S/'.$_SESSION["id"].'";
				</script>';
